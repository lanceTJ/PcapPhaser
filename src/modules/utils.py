...
def load_config(config_path='config.ini'):
    ...
    allowed_feature_names_str = config['pss']['allowed_feature_names']
    ...
    return {
        ...
        'lambda_dict': ast.literal_eval(config['pss']['lambda_dict']),
        'feature_weights': ast.literal_eval(config['pss']['feature_weights']),
        ...
        'allowed_feature_names': allowed_feature_names  # Add list conversion for allowed_feature_names
    }